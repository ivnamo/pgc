...
<html lang="en">
  <head>
    <meta charset="utf-8">
    <meta name="description" content="RRHH Desarrollo de las personas">
  ...
  <div id="divLoading">
    ...
    <!-- Navbar-->
    <header class="app-header"><a class="app-header__logo" href="<?= base_url();?>dashboard"><?php echo  $data['page_title'] ?></a>
